...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "pavilion_settings" ALTER COLUMN "settings_finale_model_light_intensity" SET DEFAULT 32;
  ALTER TABLE "_pavilion_settings_v" ALTER COLUMN "version_settings_finale_model_light_intensity" SET DEFAULT 32;`)
}
